...
function CreateNewVideo() {
    ...
    const handleGenerateVideo = async () => {
        ...
        try {
            ...
            setSuccess("Your video generation has started. You'll be notified when it's ready.");
            
            // Optional: Clear form or redirect
            setFormData({ title: "", topic: "", selectedScript: null, videoStyle: null, voice: null, captionStyle: null });
